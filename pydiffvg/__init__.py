...
Example:
    ...
    ...     fill_color=pydiffvg.SolidColor(color=torch.tensor([1.0, 0.0, 0.0, 1.0])),
    ... )
    >>>
    >>> # Render to image
...
from pydiffvg.render import RenderFunction, render
from pydiffvg.render_diff import render_differentiable
from pydiffvg.rasterize import PixelFilter
